...
export function FloatingWA() {
  ...
  return (
    <a
      ...
      aria-label="Chat WhatsApp Toko Bahan Kue Santi"
      className="fixed z-40 right-4 [bottom:calc(72px+env(safe-area-inset-bottom))] sm:bottom-6 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/30 flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
    >
      {/* WhatsApp logo — inline SVG supaya no external image */}
